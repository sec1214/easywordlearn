...
public class managedb {
	...
	public static final String PACKAGE_NAME = "com.rootsproject";// ���̰���
	...
	public void CopyDatabase() {
		...
		if (!path.exists()) { // �ļ��в����ڱ����ȴ����ļ���
			...
			try {
				is = am.open(DB_NAME);//
				this.context.getResources().getAssets().open(DB_NAME); // //����������ݿ�
	...
	public int numlist(String tablename) {
		...
		return number / listwordnum; // ��Ϊÿ�������ٰ���5���������Ա�����1��list ���Լ�1����ȷ��
	...
	public String[][] getwrongwords(String key) { // ȡ��20������ keyΪreviewֵ��
