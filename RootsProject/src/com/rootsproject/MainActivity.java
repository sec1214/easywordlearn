...
public class MainActivity extends Activity {
	...
	//	setTitle("");
		...
		myapp = (mypublicvalue) getApplication(); // public value call; ����������ֵ
	...
	//	listView.setChoiceMode(AbsListView.CHOICE_MODE_SINGLE);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				myapp.set(0, value); // store table name to public value.   0 �����ݵ��Ǳ���

				exit = false;

				myapp.playmusic(1);   // button sound

				Toast.makeText(MainActivity.this, myapp.get(0), 1).show(); // Toast show choiced table name  ��ʾ����Ŀγ�Ҳ���Ǳ���
	...
	@Override
	public boolean onPrepareOptionsMenu(Menu menu) { //this method will be call before press menu. �˵���ʾǰ ����
		// TODO Auto-generated method stub
		if (myapp.getmusic(0) == 0) {
			buttonsound.setChecked(false);
