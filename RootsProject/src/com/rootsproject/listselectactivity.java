...
public class listselectactivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String tablename = myapp.get(0); // // get the course name 锟矫碉拷锟斤拷锟斤拷
		...
		System.out.println("numberlist of the course " + numlist); // 锟斤拷锟斤拷锟叫讹拷锟斤拷list
																	// 锟斤拷为每锟斤拷锟斤拷锟斤拷锟劫帮拷锟斤拷5锟斤拷锟斤拷锟斤拷锟斤拷锟皆憋拷锟斤拷锟斤拷1锟斤拷list
		...
		ListlistView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				myapp.set(1, value); // store list name to public value 0
										// 锟斤拷锟斤拷锟捷碉拷锟角憋拷锟斤拷锟斤拷1锟斤拷锟斤拷锟捷碉拷list锟斤拷锟斤拷
			...
			if (action.equals(Intent.ACTION_CLOSE_SYSTEM_DIALOGS)) {
				...
				if (reason != null) {
					if (reason.equals(SYSTEM_HOME_KEY)) {
						myapp.pausesplashmusic(); // home key event 锟斤拷锟斤拷锟�

					} else if (reason.equals(SYSTEM_RECENT_APPS)) {
						myapp.pausesplashmusic();// long home key event 锟斤拷锟斤拷锟�
					}
				}
			}
		}
