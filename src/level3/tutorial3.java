...
public class tutorial3 extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            Intent intent = new Intent(tutorial3.this, play.class);
    ...
    public void onClickNever(View v)
    {
        //TODO: Do not show
        myapp.playmusic(1);
        Intent intent = new Intent(tutorial3.this, missroot.class);
        startActivity(intent);
