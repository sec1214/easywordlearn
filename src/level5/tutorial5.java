...
public class tutorial5 extends AppCompatActivity {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            ...
            Intent intent = new Intent(tutorial5.this, play.class);
    ...
    public void onClickNever(View v)
    {
        ...
        myapp.playmusic(1);
        Intent intent = new Intent(tutorial5.this, idroortsl5.class);
        startActivity(intent);
