				...
				if (wcon == 1) { // 错词循环下
					...
					if (key.equals(words[wordnum - 1][0])) { // 做对了
						...
						if (!words[wordnum][0].equals("")) {
							...
							Intent intent = new Intent(wordsl2.this, idroortsl2.class);
						...
						if (words[wordnum][0].equals("")) { // 错词循环结束了
							...
							Intent intent = new Intent(wordsl2.this, score.class);
					...
					if (!key.equals(words[wordnum - 1][0])) { // 错词循环下做错了
						...
						defrepeat(1); // 这是做错了加1
						Intent intent = new Intent(wordsl2.this, wordsl2.class);
						startActivity(intent);
