...
public class definition extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.ran();
		// System.out.println("停顿1秒"+Integer.parseInt(myapp.get(6)));
							...
							if (con == 1) { // 标准循环+ TT循环下
								...
								if (wordnum % 5 == 0) { // 走完5个单词了
									...
									if (words[wordnum][0].equals("")) { // 判断结束
										...
										/*
										 * Toast.makeText( definition.this,
							...
							if (con == 1) {
								...
								if (wordnum % 5 == 0) {
									...
									if (words[wordnum][0].equals("")) { // 判断结束
										 ...
										 * Intent intent = new Intent(
										 * definition.this, root.class);
										 * 
										 * startActivity(intent);
										 * 
										 * // playmusic(1); myapp.setscore(0,
										 * clicknum+1);finish();
										 * 
										 * }
										 * 
									 ...
									 * 
									 * if (h < 0.5) { Intent intent = new
									 * Intent( definition.this, words.class);
									 * startActivity(intent);
									 * 
									 * // playmusic(1); myapp.setscore(0,
									 * clicknum+1);finish();
									 ...
									 * startActivity(intent); myapp.setscore(0,
									 * clicknum+1);finish(); myapp.setscore(0,
									 * clicknum+1);finish();
									 * 
									 * } }
									 */
		...
		if (Integer.parseInt(myapp.get(6)) == 2) {
			...
			/*
			 * Toast.makeText(definition.this,
			 * "Remember Green And Correct Choice", 1).show();
			 */
			...
			TimerTask timerTask = new TimerTask() {
				...
				public void run() {
					...
					if (con == 0) {
						Intent intent = new Intent(definition.this, root.class);
						startActivity(intent);
						timer.cancel();
						finish();
					}
